...
'''
    ...
    def gear_width(self, horsepower=100, rpm=1000, ratio=4, toothtype=1, safetyfactor=2, material_serialno=1, npinion=18):
        ...
        return outstring
    #@+node:2014python.20150109180444.1825: *3* cube_weblink
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20150109180444.1827: *3* gear_weblink
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1743: *3* w12_1
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1747: *3* w12_2
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1749: *3* w12_3
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1751: *3* w12_4
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1753: *3* w12_5
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20141125100417.1755: *3* w12_6
    @cherrypy.expose
    ...
    '''
        return outstring
    #@+node:2014python.20150110174159.1948: *3* w12_7
    @cherrypy.expose
    def w12_6(self, *args, **kwargs):
        outstring = '''
    <!DOCTYPE html>
